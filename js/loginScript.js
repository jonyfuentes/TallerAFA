...
function agregarNavbar(){
    ...
    miNavBar += '<a class="nav-link dropdown-toggle" href="musica.html" id="offcanvasNavbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">Producto</a>'
    miNavBar += '<ul class="dropdown-menu" aria-labelledby="offcanvasNavbarDropdown">'
    miNavBar += '<li><a class="dropdown-item" href="../Equipo.html">Equipo</a></li>'
    miNavBar += '<li><a class="dropdown-item" href="../Vivo.html">En vivo</a></li>'
    miNavBar += '<li><a class="dropdown-item" href="../indumentaria.html">En indumentaria</a></li></ul></li>'
